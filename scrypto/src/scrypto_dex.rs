    ...
    impl ScryptoDex {
        ...
        pub fn new_liquidity_pool(
            ...
            let (liquidity_pool, tracking_tokens) = 
                Blueprint::<LiquidityPool>::instantiate_liquidity_pool(bucket1, bucket2, dec!("0.3"));
        ...
        pub fn add_liquidity(
            ...
            let optional_liquidity_pool: Option<&Global::<LiquidityPool>> = self.liquidity_pools.get(&addresses);
            match optional_liquidity_pool {
                Some (liquidity_pool) => { // If it matches it means that the liquidity pool exists.
                    ...
                    let returns: (FungibleBucket, FungibleBucket, FungibleBucket) = liquidity_pool.add_liquidity(bucket1, bucket2);
